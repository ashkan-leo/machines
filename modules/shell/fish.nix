...
with lib; {
  ...
  programs.fish = {
    ...
    shellInit = ''
      ...
      # Set the env vars here manually.
      # NOTE Nix env var integration with fish is broken
      ...
      set -x theme_display_git_ahead_verbose "no"
      set -x theme_display_git_dirty_verbose "no"
      set -x theme_display_git_stashed_verbose "no"
      set -x theme_powerline_fonts "yes"
      set -x theme_nerd_fonts "yes"
      set -x theme_use_abbreviated_branch_name "yes"
